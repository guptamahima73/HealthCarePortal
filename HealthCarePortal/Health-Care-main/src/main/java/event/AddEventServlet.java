...
public class AddEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        HttpSession session = request.getSession(false); // false = don't create new session if it doesn't exist
        ...
        response.sendRedirect("event/workerevent.jsp?message=" + URLEncoder.encode(message, "UTF-8") + "&status=" + (eventInserted ? "success" : "error"));
